...
add_filter("wpcf7_form_tag", function($scanned_tag, $replace){
    ...
    if ("press_post" === $scanned_tag["name"]) {
        ...
        $scanned_tag['raw_values'] = [
            "Je ne sais pas comment me lancer sur les réseaux sociaux | Je ne sais pas comment me lancer sur les réseaux sociaux",
            "Je souhaite augmenter mes communautés |Je souhaite augmenter mes communautés ",
            "Je souhaite augmenter mon engagement | Je souhaite augmenter mon engagement ",
            "Je n'arrive pas à vendre sur les réseaux sociaux | Je n'arrive pas à vendre sur les réseaux sociaux ",
            "J'ai besoin de conseil pour lancer une activations avec des influenceurs | J'ai besoin de conseil pour lancer une activations avec des influenceurs",
        ];
